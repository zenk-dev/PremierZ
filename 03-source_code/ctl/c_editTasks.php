...
/*----------------------------------------------------------------------------
  例外定義
  ----------------------------------------------------------------------------*/
	function my_exception_edittask(Exception $e){
		//echo "例外が発生しました。";
		//echo $e->getMessage();
	...
	set_exception_handler('my_exception_edittask');
...
/*----------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------------*/
	...
	if($l_debug_mode==1){print("Step-POST値の取得とチェック");var_dump($lr_data);print "\n";}
/*----------------------------------------------------------------------------
  データチェック
  ----------------------------------------------------------------------------*/
