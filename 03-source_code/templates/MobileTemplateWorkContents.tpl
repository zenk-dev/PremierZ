...
<body>
	...
	<div>{$headinfo}<br></div>
	<!-- 項目表示 -->
	{foreach from=$ar_workstaff item=l_ar_workstaff}
		<div mode="nowrap">{$l_ar_workstaff.value}<br><br></div>
	{foreachelse}
		<div>&nbsp;現在ご登録頂いております作業はございません。<br>&nbsp;ご依頼させていただいた際はよろしくお願い申し上げます。<br><br></div>
	{/foreach}
	<!-- ページ移動リンク -->
	<div>{$move_comp}</div>
	<hr>
