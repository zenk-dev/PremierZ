...
<div id="id_div_outer" >
	...
	<div id="id_div_hd">
		<hr id="id_hr_hd"></hr>
		<span id="id_span_hd">{$systemname} ログイン</span>
	</div>
	<br>
	<br>
	<div id="id_div_main">
		<form id="id_form_main" method="" action="">
			<table id="id_table_main">
				<tr id="id_tr_main1" class="c_tr_main">
					<td class="c_td_main_top" colspan=2>&nbsp;</td>
				</tr>
				...
				<tr id="id_tr_main2" class="c_tr_main">
					<td class="c_td_main" id="id_td_main_pass">パスワード</td>
		...
		<br>
		<div id="id_div_pcmob">
			PC&nbsp;/&nbsp;<a href="../mobile/login.php">Mobile</a>
		</div>
		<br>
		<div id="id_div_pcr">
			<a href="../page/passwordChangeRequest.php">パスワードを忘れた方はこちら</a>
		</div>
		<br>
		<br>
	</div>
