   ...
   =============================================================================*/
	function checkMobiles() {
		...
		/*--------------------*/
			...
			/*  InternetExplorer  */
			/*--------------------*/
			} else if(ereg(AGENT_MSIE, $useragent)) {
				$model		=	MODEL_MSIE;
				
			/*--------------------*/
			/*  FireFox           */
			/*--------------------*/
			} else if(ereg(AGENT_FIREFOX, $useragent)) {
				$model		=	MODEL_FIREFOX;
				
			/*--------------------*/
			/*  Opera            */
			/*--------------------*/
			} else if(ereg(AGENT_OPERA, $useragent)) {
				$model		=	MODEL_OPERA;
				
			/*--------------------*/
			/*  GoogleChrome      */
			/*--------------------*/
			} else if(ereg(AGENT_CHROME, $useragent)) {
				$model		=	MODEL_CHROME;
				
			/*--------------------*/
			/*  Safari            */
			/*--------------------*/
			} else if(ereg(AGENT_SAFARI, $useragent)) {
				$model		=	MODEL_SAFARI;
