...
*******************************************************************************/
/*******************************************************************************
 作業拠点編集画面表示用javascript関数
*******************************************************************************/
var $obj_main_form;											// POST対象オブジェクト
var $this_page_file		= "";
var $edit_page			= "../ctl/c_editWorkplace.php";		// 作業拠点更新
...
function callBackFnc($p_data){
	...
	//	movePage($obj_hidden_form_list, $this_page_file);
		...
		// 正常終了
		alert("作業拠点管理情報を更新しました。");
		// 親ウインドウを判別しファイル名をセット
		if($parent_pagename == "workbase"){
			$this_page_file = "workplace_mnt.php";
