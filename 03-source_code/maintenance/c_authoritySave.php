...
// ==================================
	...
	set_exception_handler('my_exception_authoritySave');
...
// ==================================
	// 新規か更新かの判別
	// AUTHORITY_IDがNULLの場合は新規とみなす
	if($_POST["AUTHORITY_ID"] == ''){
		$l_mode = "INS";
	}else{
		$l_mode = "UPD";
	}
	...
	$lr_cmc_result = $lc_cmc->checkValue($_POST, 'AUTHORITY', $l_mode);
...
// ==================================
	...
	$lc_mvld = new m_authority_master();
	if($l_mode == "INS"){
		// 新規登録
