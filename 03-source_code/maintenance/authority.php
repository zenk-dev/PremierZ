...
// ==================================
	...
	// jsファイル
	$ar_js_files	= array(DIR_JS . "jquery.js", "maintenance.js", "authority.js", "mntMain.js");
...
// ==================================
	...
	$lc_smarty->assign("maintitle",		"権限管理");					// メインタイトル
	...
	$lr_data_id = $lc_authority->getDATAID();
