...
// 例外定義
// ==================================
	function my_exception_valueListSave(Exception $e){
		echo "例外が発生しました。".$l_txt_rts;
		echo $e->getMessage();
		return;
    }
	set_exception_handler('my_exception_valueListSave');
...
// ==================================
	...
	$lr_cmc_result = $lc_cmc->checkValue($_POST, 'VALUE_LIST_DEFINES', $l_mode);
