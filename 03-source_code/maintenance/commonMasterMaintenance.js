...
/*******************************************************************************
 commonMaster編集画面処理
*******************************************************************************/
var $insupd_post_to			= "c_commonMasterSave.php";			// 新規登録、更新処理でPOSTするphpファイル
var $return_post_to			= "commonMaster.php";				// 一覧に戻る処理でPOSTするphpファイル
...
var $prekey_colname			= "CODE_ID";						// 主キーのDB項目名
var $pkey_item_name			= "nm_code_id";						// 主キーの隠し項目名(権限ID)
