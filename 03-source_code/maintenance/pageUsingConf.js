...
var $this_page				= "pageUsingConf.php";			// 自ページのファイル名
var $key_item_colnum		= "2";							// 更新や削除のキーとなる項目の列番号
var $del_post_to			= "c_pageUsingConfDel.php";		// 削除処理でPOSTするphpファイル
var $insupd_post_to			= "pageUsingConfMaintenance.php";	// 新規登録、更新処理でPOSTするphpファイル
...
function procDelete($p_checked_index){
	...
	alert("PAGE_USING_CONF_ID:"+$lr_param_del[$pkey_item_name]+" を削除しました");
}
// コールバック関数
