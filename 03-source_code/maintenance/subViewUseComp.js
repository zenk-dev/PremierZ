...
function saveUseComp(){
	...
	*************************/
	...
	if($lr_data["smtp_server"]){
		...
		// 入力されていない場合は背景色を変更する
		$lo_target.css("background-color", $alert_color);
		$alert_mess = $alert_mess + "SMTPサーバを入力して下さい。" + "\n";
		$status_code = 1;
	}
	...
	if($lr_data["smtp_port"]){
		...
		// 入力されていない場合は背景色を変更する
		$lo_target.css("background-color", $alert_color);
		$alert_mess = $alert_mess + "SMTPサーバのポート番号を入力して下さい。" + "\n";
		$status_code = 1;
	}
	...
	if($lr_data["smtp_account"]){
		...
		// 入力されていない場合は背景色を変更する
		$lo_target.css("background-color", $alert_color);
		$alert_mess = $alert_mess + "SMTPサーバのアカウントを入力して下さい。" + "\n";
		$status_code = 1;
	}
	...
	if($lr_data["smtp_pass"]){
		...
		// 入力されていない場合は背景色を変更する
		$lo_target.css("background-color", $alert_color);
		$alert_mess = $alert_mess + "SMTPサーバのパスワードを入力して下さい。" + "\n";
		$status_code = 1;
	}
	...
	if($lr_data["mail_manager"]){
		...
		// 入力されていない場合は背景色を変更する
		$lo_target.css("background-color", $alert_color);
		$alert_mess = $alert_mess + "作業取り纏め用アドレスを入力して下さい。" + "\n";
		$status_code = 1;
	}
	...
	if($lr_data["mail_report"]){
		...
		// 入力されていない場合は背景色を変更する
		$lo_target.css("background-color", $alert_color);
		$alert_mess = $alert_mess + "勤怠報告用アドレスを入力して下さい。" + "\n";
		$status_code = 1;
	}
