...
/*******************************************************************************
 commonMaster画面処理
*******************************************************************************/
var $insupd_post_to			= "c_valueListSave.php";			// 新規登録、更新処理でPOSTするphpファイル
var $return_post_to			= "valueList.php";					// 一覧に戻る処理でPOSTするphpファイル
var $input_item				= "input.c_inp_main_dtl_val,select.c_sel_main_dtl_val,textarea.c_txta_main_dtl_val"; // 保存値を収集する項目のDOM
var $org_input_item			= "input.c_inp_main_dtl_orgval";	// 元の値を収集する項目のDOM
var $prekey_colname			= "DEFINE_ID";						// 主キーのDB項目名
var $pkey_item_name			= "nm_define_id";					// 主キーの隠し項目名(権限ID)
