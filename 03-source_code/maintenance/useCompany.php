...
// 例外定義
// ==================================
	function my_exception_usecompmain(Exception $e){
		echo "例外が発生しました。";
		echo $e->getMessage();
		return;
    }
	set_exception_handler('my_exception_usecompmain');
...
// ==================================
	...
	$ar_css_files	= array(
							"v_mnt_main.css",
							"v_sub_view_usecomp.css",
							"v_mnt_usecomp_detail.css"
							);
	// jsファイル
	$ar_js_files	= array(
							DIR_JS."jquery.js",
...
// ==================================
	...
	$lc_smarty->assign("maintitle",		"利用会社管理");				// メインタイトル
	
	
	if($l_debug_mode==1){print("Step-クラスインスタンス作成");print "<br>";}
	// ------------------------------
	// 利用会社データ取得
	// ------------------------------
	...
	// order byセット
	$lr_orderby = array("DATA_ID");
	$lc_muc->setOrderyBy($lr_orderby);
	...
	if($l_debug_mode==1){print("Step-利用会社データ取得");print "<br>";}
	// ------------------------------
	// 明細領域
	// ------------------------------
	
	$lc_smarty->assign("ar_usecomp_dtl",	$lr_dtlrec);
	...
	if($l_debug_mode==1){print("Step-明細領域");print "<br>";}
// ==================================
// ページ表示
// ==================================
	$lc_smarty->display('UseCompany.tpl');
