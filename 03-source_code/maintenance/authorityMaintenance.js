...
/*******************************************************************************
 commonMaster画面処理
*******************************************************************************/
var $insupd_post_to			= "c_authoritySave.php";			// 新規登録、更新処理でPOSTするphpファイル
var $return_post_to			= "authority.php";					// 一覧に戻る処理でPOSTするphpファイル
var $reload_post_to			= "authorityMaintenance.php";		// 再読み込みでPOSTするphpファイル
...
var $prekey_colname			= "AUTHORITY_ID";					// 主キーのDB項目名
