...
<div id="id_subv_div_outer">
	...
	<!-- SMTPサーバ -->
		<tr class="c_subv_tr_dtl">
			<td class="c_subv_td_dtl_cap">
				SMTPサーバ<span class="c_span_required">*</span>
			</td>
			<td class="c_subv_td_dtl_verylongtext">
	...
	<!-- ポート番号 -->
		<tr class="c_subv_tr_dtl">
			<td class="c_subv_td_dtl_cap">
				SMTPサーバのポート番号<span class="c_span_required">*</span>
			</td>
			<td class="c_subv_ipt_dtl_shorttext">
	...
	<!-- アカウント -->
		<tr class="c_subv_tr_dtl">
			<td class="c_subv_td_dtl_cap">
				SMTPサーバのアカウント<span class="c_span_required">*</span>
			</td>
			<td class="c_subv_td_dtl_verylongtext">
	...
	<!-- パスワード -->
		<tr class="c_subv_tr_dtl">
			<td class="c_subv_td_dtl_cap">
				SMTPサーバのパスワード<span class="c_span_required">*</span>
			</td>
			<td class="c_subv_td_dtl_verylongtext">
	...
	<!-- 作業取り纏め用 -->
		<tr class="c_subv_tr_dtl">
			<td class="c_subv_td_dtl_cap">
				作業取り纏め用アドレス<span class="c_span_required">*</span>
			</td>
			<td class="c_subv_td_dtl_verylongtext">
	...
	<!-- 勤怠報告用 -->
		<tr class="c_subv_tr_dtl">
			<td class="c_subv_td_dtl_cap">
				勤怠報告用アドレス<span class="c_span_required">*</span>
			</td>
			<td class="c_subv_td_dtl_verylongtext">
