...
// =============================================================================
	function updateRecord($p_user_id, $pr_value){
		...
		$l_sql .= $this->getUpdataSetPhrase("DATA_ID", 						$pr_data["DATA_ID"], 					'N').",";	// DATA_ID
		$l_sql .= $this->getUpdataSetPhrase("PAGE_CODE", 					$pr_data["PAGE_CODE"], 					'C').",";	// PAGE_CODE
		$l_sql .= $this->getUpdataSetPhrase("PAGE_NAME", 					$pr_data["PAGE_NAME"], 					'C').",";	// PAGE_NAME
		$l_sql .= $this->getUpdataSetPhrase("ALLOWED_AUTHCODE", 			$pr_data["ALLOWED_AUTHCODE"], 			'C').",";	// ALLOWED_AUTHCODE
