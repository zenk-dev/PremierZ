...
class m_message_template extends ModelCommon{
/*******************************************************************************
	クラス名：m_message_template.php.php
	処理概要：メッセージテンプレートモデル
*******************************************************************************/
	...
	private $set_view_name	= 'MESSAGE_TEMPLATE';	// ビュー名
	private $set_table_name	= 'MESSAGE_TEMPLATE';	// テーブル名
	//※table_nameはModelCommonで定義されています

	private $primary_key_col = 'MESSAGE_TEMPLATE_ID';	// 主キーの項目
...
/*============================================================================
  ...
  ============================================================================*/
	function execInsert($pr_data, $p_user_id = '-1'){
		...
		$l_sql  = "insert into `MESSAGE_TEMPLATE` ";
		$l_sql .= "(";
		//$l_sql .= "'MESSAGE_TEMPLATE_ID',";
		$l_sql .= "MESSAGE_TEMPLATE_NAME,";
		$l_sql .= "MESSAGE_CATEGORY,";
		$l_sql .= "MESSAGE,";
		$l_sql .= "VALIDITY_FLAG,";
		...
		$l_sql .= "'".$this->getMysqlEscapedValue($pr_data["MESSAGE_TEMPLATE_NAME"])."',";		// REMARK
		$l_sql .= "'".$this->getMysqlEscapedValue($pr_data["MESSAGE_CATEGORY"])."',";			// REMARK
		$l_sql .= "'".$this->getMysqlEscapedValue($pr_data["MESSAGE"])."',";						// REMARK
...
/*============================================================================
  ...
  ============================================================================*/
	function deleteRecord(){
		...
		// SQL組み立て
		$l_sql  = "delete from `MESSAGE_TEMPLATE` ";
