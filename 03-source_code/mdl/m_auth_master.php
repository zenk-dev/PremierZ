...
class m_auth_master extends ModelCommon{
/*******************************************************************************
	クラス名：m_auth_master.php
	処理概要：ユーザーマスタモデル
*******************************************************************************/
	...
	private $set_view_name	= 'AUTHORITY_V';	// ビュー名
	private $set_table_name	= 'AUTHORITY';		// テーブル名
	//※table_nameはModelCommonで定義されています
	
	private $primary_key_col = 'AUTHORITY_ID';	// 主キーの項目
