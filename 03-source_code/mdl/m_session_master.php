...
class m_session_master extends ModelCommon{
/*******************************************************************************
	クラス名：m_session_master.php
	処理概要：セッションマスタモデル
*******************************************************************************/
	...
	private $set_view_name	= 'SESSIONS_V';	// ビュー名
	private $set_table_name	= 'SESSIONS';	// テーブル名
	//※table_nameはModelCommonで定義されています
	private $primary_key_col = 'SESSION_ID';	// 主キーの項目
