...
/******************************************************************************
 ファイル名：project_xls_import.php
 処理概要   各種情報一括登録画面
 ※companies_edit.phpをもとに作成したxls_import.phpをもとに作成したので諸々要らない処理が混ざってます。
 GET受領値：
******************************************************************************/
...
/*----------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------------*/
	function getCommonMaster($lr_where){
		...
		$lc_common = new m_common_master('Y', $lr_where);
...
//	$l_edit_sql_type = "update";
	...
	// チェックボックス
	$ar_checkbox = array(
		array("type" => "checkbox", "id" => "id_chk_pj",	 "name" => "ins_pj"		, "value" => "1", "label" => "プロジェクト管理"),
		array("type" => "checkbox", "id" => "id_chk_task",	 "name" => "ins_task"	, "value" => "1", "label" => "作業管理"),
		array("type" => "checkbox", "id" => "id_chk_staff",	 "name" => "ins_staff"	, "value" => "1", "label" => "人員管理"),
	);
...
/*-----------------------------------
  ...
  -----------------------------------*/
	...
	// jsファイル
	$ar_js_files	= array(DIR_JS."jquery.js", DIR_JS."jfnc_common.js", DIR_JS."jfnc_common_edit.js", DIR_JS."jfnc_projects_xls_import.js", DIR_JS."jquery.updnWatermark.js",DIR_JS."jquery_upload.js");
...
/*-----------------------------------
  ...
  -----------------------------------*/
	...
	// インクルードするテンプレート
	// ------------------------------
	$lc_smarty->assign("edit_include_tpl"				, "projects_xls_import_block.tpl");	// 編集
