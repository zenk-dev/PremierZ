...
// 例外定義
// ==================================
	function my_exception_entrance(Exception $e){
	...
	set_exception_handler('my_exception_entrance');
...
// ==================================
	...
	// jsファイル
	$ar_js_files	= array(DIR_JS."jquery.js", DIR_JS."jfnc_common.js", DIR_JS."jfnc_entrance.js");
	// コピーライト
...
// ==================================
	...
	$lc_smarty->assign("headtitle",		SYSTEM_NAME."ログイン");		// タイトル
...
// ページ表示
// ==================================
	$lc_smarty->display('Entrance.tpl');
